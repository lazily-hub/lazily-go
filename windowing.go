...
func (w *TumblingCountWindow[T]) OutputCell() *Source[Opt[T]] { return w.output }
...
// OutputCell returns the reactive cell holding the last emitted aggregate.
func (w *TumblingTimeWindow[T]) OutputCell() *Source[Opt[T]] { return w.output }
...
// OutputCell returns the reactive cell holding the last emitted aggregate.
func (w *SlidingWindow[T]) OutputCell() *Source[Opt[T]] { return w.output }
...
// OutputCell returns the reactive cell holding the last emitted aggregate.
func (w *SessionWindow[T]) OutputCell() *Source[Opt[T]] { return w.output }
